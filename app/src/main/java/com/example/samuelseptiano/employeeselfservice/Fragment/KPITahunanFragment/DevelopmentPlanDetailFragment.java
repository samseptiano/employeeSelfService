...
public class DevelopmentPlanDetailFragment extends Fragment implements ListImprovementAreaFullScreenAdapter.EventListener{
    ...
    String empName, jobTitle, dept, branchName, jobStatus, empPhoto, empNik, hasApprove,canApprove,apprseq;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        observable.subscribeOn(Schedulers.newThread()).
                ...
                .subscribe(new Observer<KPIHeader>() {
                    ...
                    listImprovementAreaAdapter = new ListImprovementAreaFullScreenAdapter(devPlanHeaderList,kpiHeader, getContext(), "Y",empPhoto,empName,branchName,DevelopmentPlanDetailFragment.this);
                                        ...
                                        public void onResponse(Call<Void> call, Response<Void> response) {
                                            ...
                                            call2.enqueue(new Callback<KPIAnswerList>() {
                                                ...
                                                public void onResponse(Call<KPIAnswerList> call, Response<KPIAnswerList> response) {
                                                    Toast.makeText(getContext(),"Approved Successfully!!",Toast.LENGTH_LONG).show();
                                                }
                                                @Override
