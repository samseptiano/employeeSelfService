...
public class TotalFragment extends Fragment implements UpdateableFragmentListener,KPIApproveListAdapterTahunan.EventListener {
    ...
    public TotalFragment(String s) {
        type = s;

        // Required empty public constructor
    }

    public static TotalFragment newInstance(String s) {
        TotalFragment fragment = new TotalFragment(s);
        return fragment;
    }
...
//        Call<List<KPIApproveList>> call = apiService.getuserList("030300324","Bearer "+usr.get(0).getToken());
...
//            });
    ...
    public void update(FilterPAModel filterPAModel) {
        Toast.makeText(getContext(),"Operan: "+type+" " + filterPAModel.getDirektorat(),Toast.LENGTH_LONG).show();
    }
