            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b){
                    ...
                    for(int i=0;i<paSettingHeaderList.size();i++){
                        if(setupPositionDetailModelList.get(position).getSemester().equals( paSettingHeaderList.get(0).getPaSettingDetails().get(i).getSemester())
                        &&setupPositionDetailModelList.get(position).getId().equals(paSettingHeaderList.get(0).getPaSettingDetails().get(i).getCompID())){
                            paSettingHeaderList.get(0).getPaSettingDetails().get(i).setChecked(true);
                        }
                    }
                    ...
                    for(int i=0;i<paSettingHeaderList.size();i++){
                        if(setupPositionDetailModelList.get(position).getSemester().equals( paSettingHeaderList.get(0).getPaSettingDetails().get(i).getSemester())
                                &&setupPositionDetailModelList.get(position).getId().equals(paSettingHeaderList.get(0).getPaSettingDetails().get(i).getCompID())){
                            paSettingHeaderList.get(0).getPaSettingDetails().get(i).setChecked(false);
                        }
                    }                    listener.setPaSettingHeaderKualitatifList(paSettingHeaderList);
                    listener.setSetupPositionDetailModels(setupPositionDetailModelList);
