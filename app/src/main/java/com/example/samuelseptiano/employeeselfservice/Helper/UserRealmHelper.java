    ...
    public ArrayList<UserRealmModel> findAllArticle() {
        ...
        if (realmResult.size() > 0) {
            ...
            for (int i = 0; i < realmResult.size(); i++) {
                String id, userId, lastUpdateBy, fGActiveYN, lastUpdate, username, empEmail, password, empNIK, token, userQR, lastChangePassword, empName, dept, companyName,companyCode,locationName,locationCode,jobTitleName,jobTitleCode, positionId,isPKAccessed, nikAtasan, namaAtasan, posAtasan, nikAtasan2, namaAtasan2, posAtasan2, branchName;
                ...
                data.add(new UserRealmModel( id,  userId,  lastUpdateBy,  fGActiveYN,  lastUpdate,  lastChangePassword,  username,  empEmail,  password,  empNIK,  token,  userQR,  empName,  dept,  jobTitleName,  jobTitleCode,  companyName,  companyCode,  locationName,  locationCode,positionId, isPKAccessed,nikAtasan,namaAtasan,posAtasan,nikAtasan2,namaAtasan2,posAtasan2,branchName));
