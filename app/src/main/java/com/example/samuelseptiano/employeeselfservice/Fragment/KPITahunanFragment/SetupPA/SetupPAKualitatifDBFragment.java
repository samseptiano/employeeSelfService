...
import com.example.samuelseptiano.employeeselfservice.Model.APIModel.SetupPA.SetupPositionKualitatifModel;
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<paSettingHeaderKualitatifList.size();i++){
                    ...
                    if(paSettingHeaderKualitatifList.get(i).isChecked() && paSettingHeaderKualitatifList.get(i).getBobot().equals("100")) {
                    ...
                    else if(paSettingHeaderKualitatifList.get(i).isChecked() && !paSettingHeaderKualitatifList.get(i).getBobot().equals("100")){
                            ctr++;
                    }
                }
