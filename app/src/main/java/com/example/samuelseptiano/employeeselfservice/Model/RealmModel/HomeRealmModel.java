...
public class HomeRealmModel extends RealmObject {
    ...
    public HomeRealmModel(String id, String eventId, String eventName, String eventType, String externalEventCode, String eventDesc, String eventImage, String fGHasPasscodeYN, String passcode, String fGHasSurveyYN, String surveyId, String fGSurveyDoneYN) {
        this.id = id;
        this.eventId = eventId;
        this.eventName = eventName;
        this.eventType = eventType;
