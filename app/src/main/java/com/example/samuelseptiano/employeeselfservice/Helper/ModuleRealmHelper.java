...
import com.example.samuelseptiano.employeeselfservice.Model.ModuleModel;
    ...
    public ArrayList<ModuleRealmModel> findAllArticle() {
        ...
        if (realmResult.size() > 0) {
            ...
            for (int i = 0; i < realmResult.size(); i++) {
                String id, moduleCode,modulename,icon,moduleStatus;
                ...
                data.add(new ModuleRealmModel( id,moduleCode,modulename,icon, moduleStatus));
                }
