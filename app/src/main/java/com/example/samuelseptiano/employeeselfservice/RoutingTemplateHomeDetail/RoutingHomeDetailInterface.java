...
public interface RoutingHomeDetailInterface {
    ...
    void routingChat(String roomName, String friendName, String friendNik, String semester, String tahun, String kualitatif, String kuantitatif, Context context, List<String> KPIItems, String friendBranchName, String friendDept,String friendJobTitle, String foto);
}