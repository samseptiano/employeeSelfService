...
//        home = homeRealmHelper.findCategoryArticle(getCategory());
        ...
        if(ConnectivityReceiver.isConnected()){
            //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ItemViewModel itemViewModel = ViewModelProviders.of((MainActivity)getActivity(), new ViewModelProvider.Factory() {
                @NonNull
                @Override
...
//                        hhAdapter.filter(text);
    ...
    private void  replaceSubscription(String userName) {
        itemViewModel.replaceSubscription(this, userName);
