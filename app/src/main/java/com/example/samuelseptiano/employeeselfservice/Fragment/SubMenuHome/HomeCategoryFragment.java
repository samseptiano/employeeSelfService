...
public class HomeCategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Event Category");
    ...
    private void refreshData(){
        ...
        if(isConnState()){
            ...
            call.enqueue(new Callback<List<Home>>() {
                ...
                public void onResponse(Call<List<Home>> call, Response<List<Home>> response) {
                    ...
                    if(home.isEmpty()){ //db realm empty
                        ...
                        hAdapter = new HomeCategoryAdapter(homes,getContext(),isConnState());
                        ...
                        hAdapter = new HomeCategoryAdapter(homess,getContext(),isConnState());
                        recyclerView.setAdapter(hAdapter);
            ...
            ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(homess.get(0).getEventType());
            hAdapter = new HomeCategoryAdapter(homess,getContext(),isConnState());
            recyclerView.setAdapter(hAdapter);
        }
    }
