...
public class KPIHeader implements Serializable {
    ...
    public KPIHeader(String tahun, String semester, String bobot, String status, String atasanLangsung, String NIKAtasanLangsung, String fotoAtasanLangsung, String atasanTakLangsung, String NIKAtasanTakLangsung, String fotoAtasanTakLangsung, String bawahanLangsung, String empName, String NIK, String dept, List<KPIQuestions> kpiQuestionsList, String status1, String status2, String company, String locationName) {
        this.tahun = tahun;
        this.semester = semester;
        this.bobot = bobot;
        this.status = status;
