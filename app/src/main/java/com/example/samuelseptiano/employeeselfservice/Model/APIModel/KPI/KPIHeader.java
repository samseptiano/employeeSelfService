...
public class KPIHeader implements Serializable {
    ...
    public KPIHeader(String tahun, String semester, String bobot, String status, String atasanLangsung, String atasanTakLangsung, String bawahanLangsung, String empName, String NIK, String dept, List<KPIQuestions> kpiQuestionsList, String status1, String status2, String company, String locationName) {
        this.tahun = tahun;
