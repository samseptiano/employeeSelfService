...
public class KPIFillTahunanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_kpifill_tahunan, container, false);
        ((AppCompatActivity)getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
...
//        tabLayout.getTabAt(1).setIcon(R.drawable.ic_home_black_24dp);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        bundle6.putString("id", nik);
        bundle6.putString("KPIType","");
