...
//    public static final String BASE_URL = "http://10.163.202.81:18471/api/";
    public static String BASE_URL =  "https://e-recruitment.enseval.com/e-kiosk/api/";
    ...
    public static Retrofit getClient() {
        ...
        if (retrofit==null) {
            retrofit = new Retrofit.Builder()
                    ...
                    .client(client.build()) // .client(getUnsafeOkHttpClient().build())
                    .build();
        }
        return retrofit;
    }
