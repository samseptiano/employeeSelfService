...
import com.example.samuelseptiano.employeeselfservice.Model.APIModel.SetupPA.PASetting.PASettingSettingKualitatif;
    ...
    private void showSettingDialog(String title, int pos){
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<Void> call = apiService.postPAKPISettingSettingKualitatif(aaa,"Bearer "+usr.get(0).getToken());
