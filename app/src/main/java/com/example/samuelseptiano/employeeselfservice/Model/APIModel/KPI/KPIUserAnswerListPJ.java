...
public class KPIUserAnswerListPJ {
    ...
    public KPIUserAnswerListPJ(String empNIK, String semester, String status, String dept, String KPIType, List<KPIQuestionsPJ> kpiUserAnswerList, List<String> imgCapture, String kelebihan, String kekurangan, String rencanaTindaklanjut, String pendukung, String penghambat, String catatanLain) {
        this.empNIK = empNIK;
        this.semester = semester;
        this.status = status;
        this.dept = dept;
