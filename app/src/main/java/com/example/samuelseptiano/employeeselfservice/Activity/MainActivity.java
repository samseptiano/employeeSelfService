...
import com.example.samuelseptiano.employeeselfservice.Fragment.KPITahunanFragment.SetupPA.SetupPAKualitatifDBFragment;
                ...
                if((kh.getNIKAtasanTakLangsung().equals(usr.get(0).getEmpNIK()) && kh.getStatus().equals("C"))){
                    ...
                    alertbox.setOnShowListener( new DialogInterface.OnShowListener() {
                        ...
                        public void onShow(DialogInterface arg0) {
                            alertbox.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(getColor(R.color.light_grey));
...
//                        .show();
                ...
                if(!((DevelopmentPlanDetailFragment) f).getUbah()) {
                    getSupportFragmentManager().popBackStack();
                }
                else{
                    AlertDialog alertbox = new AlertDialog.Builder(this)
