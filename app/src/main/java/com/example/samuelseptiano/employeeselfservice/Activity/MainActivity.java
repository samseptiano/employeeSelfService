...
public class MainActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    public List<View> lnList;
    public List<CheckBox> cbList;
    public List<TextView> tvNumbList;
    public List<TextView> tvTitleList;
    public List<EditText>edtDevelopmentActivitiesList;
    public List<EditText>edtKPIList;
    public  List<EditText>edtDueDateList;
    public List<EditText>edtMentorsList;
    public List<EditText>edtAchievementRecommendationList;
    public List<ImageButton>imgExpandList;
    public List<LinearLayout>lnExpandList;
    public List<LinearLayout> lnDevplansDetail;
    public IDPLayoutListModel idpLayoutListModel;
    public List<IDPLayoutListModel> listIDP;
    //=====================================================================

    //============== Detail =========================
    public List<Button> btnevplan;
    public List<CheckBox> cbDevplan;
    public List<TextView> tvDevplan;
    public List<LinearLayout> lnDevplans;
    public DevelopmentPlanLayoutListModel developmentPlanLayoutListModel;
    public List<DevelopmentPlanLayoutListModel> listDevPlan;
