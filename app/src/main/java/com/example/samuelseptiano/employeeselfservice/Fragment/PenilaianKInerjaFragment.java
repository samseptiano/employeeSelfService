...
public class PenilaianKInerjaFragment extends Fragment {
    ...
    ImageButton btnStartPA, btnStatusPA, btnFinalPA, btnDevelopmentPlan, btnSelfAppraisal;
        ...
        btnSelfAppraisal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConnectivityReceiver.isConnected()) {
                    ...
                    routingHomeDetailInterface.routingKPI("Approve PA tahunan",getContext(),userList,"");
                }
                else{
