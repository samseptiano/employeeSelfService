...
public class HomeRealmHelper {
    ...
    public ArrayList<HomeRealmModel> findAllArticle() {
        ...
        if (realmResult.size() > 0) {
            ...
            //Toast.makeText(context,"fdsfsdfsd",Toast.LENGTH_LONG).show();

            for (int i = 0; i < realmResult.size(); i++) {
                String id, eventId, eventName, eventType,  externalEventCode, eventDesc,  eventImage, fGHasPasscodeYN, passcode, fGHasSurveyYN, surveyId, fGSurveyDoneYN;
                ...
                data.add(new HomeRealmModel( id,eventId,eventName,eventType,externalEventCode,eventDesc,eventImage, fGHasPasscodeYN,passcode,fGHasSurveyYN, surveyId, fGSurveyDoneYN));
            }
    ...
    public HomeRealmModel findArticle(String idd) {
        ...
        if (realmResult.size() > 0) {
            ...
            for (int i = 0; i < realmResult.size(); i++) {
                ...
                data = new HomeRealmModel( id,eventId,eventName,eventType,externalEventCode,eventDesc,eventImage, fGHasPasscodeYN,passcode,fGHasSurveyYN, surveyId, fGSurveyDoneYN);
            }
