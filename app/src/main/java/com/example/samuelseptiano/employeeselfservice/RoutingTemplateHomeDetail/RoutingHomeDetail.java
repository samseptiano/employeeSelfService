...
public class RoutingHomeDetail implements RoutingHomeDetailInterface {
    ...
    public void routingKPI(String choice, Context context, UserList userList, String type, String tahun){
        switch(choice) {
            ...
            case "Penilaian":
                // code block
                fr = new PenilaianKInerjaFragment();
    ...
    public void routingChat(String roomName, String friendName, String friendNik, String semester, String tahun, String kualitatif, String kuantitatif, Context context, List<String> KPIItems,String friendBranchName,String friendDept, String friendJobTitle,String foto){
        fr = new ChatFragment();
        Bundle bundle = new Bundle();
