...
public class RoutingHomeDetail implements RoutingHomeDetailInterface {
    ...
    public void routingChat(String roomName,String friendName, String friendNik,String semester,String tahun,String kualitatif,String kuantitatif, Context context){
        fr = new ChatFragment();
        Bundle bundle = new Bundle();
