...
//                    Toast.makeText(context,"hiyaa "+questions.get(position - 1).getMessageNotification(),Toast.LENGTH_SHORT).show();
                    ...
                    if(kpiHeader.getKpiQuestionsList().get(position-1).isNotif()){
...
//            semester = (TextView) view.findViewById(R.id.tvSemester);
    ...
    private class FooterViewHolder extends RecyclerView.ViewHolder {
        ...
        public FooterViewHolder(View view) {
            ...
            listImprovementAreaAdapter = new ListImprovementAreaAdapter(devPlanHeaderList,kpiHeader, context, listener.isEditables(),type);
            ...
            Log.e(TAG, position + " :setOptions: " + question.toString());
                ...
                if (question.isAnswered()) {
                    ...
                    switch (question.getCheckedId()) {
                        case 1:
                            progress = rating.getProgressDrawable();
                            DrawableCompat.setTint(progress,context.getResources().getColor(R.color.red));
            ...
            rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
                ...
                public void onRatingChanged(RatingBar ratingBar, float ratings, boolean fromUser) {
                    ...
                    if(kpiHeader.getSemester().equals("1")){
                        ...
                        case 0:
                            Drawable progress = rating.getProgressDrawable();
                            DrawableCompat.setTint(progress,context.getResources().getColor(R.color.placeholder_grey));
                                tvIndicator.setText("Field Cannot Empty!");
                                tvIndicator.setTextColor(context.getResources().getColor(R.color.placeholder_grey));
                                break;
                            case 1:
                                progress = rating.getProgressDrawable();
                                DrawableCompat.setTint(progress,context.getResources().getColor(R.color.red));
