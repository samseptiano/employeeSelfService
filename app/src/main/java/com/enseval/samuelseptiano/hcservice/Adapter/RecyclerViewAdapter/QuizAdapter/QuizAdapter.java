package com.enseval.samuelseptiano.hcservice.Adapter.RecyclerViewAdapter.QuizAdapter;
                    ...
                    public void onClick(View view) {
                       ...
                       //linearLayoutContainer.requestFocus();
                        ...
                        for (int i = 0; i < questions.size(); i++) {
                            ...
                            } else if (questions.get(i).getQuestiontype().equals("E") && questions.get(i).getChoice() != null && !questions.get(i).getChoice().equals("")) {
                                answerrEssay++;
...
//                            }
                            ...
                            if(userAnswer.getAnswerEssay()!=null) {
                                luserAnswer.add(userAnswer);
                            }
                        }

                        if(questions.size() != luserAnswer.size()){
                            Toast.makeText(context, "Please fill all fields..", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            String json = new Gson().toJson(luserAnswer);
                            // Toast.makeText(context, " : " + Integer.toString(luserAnswer.size()), Toast.LENGTH_SHORT).show();
