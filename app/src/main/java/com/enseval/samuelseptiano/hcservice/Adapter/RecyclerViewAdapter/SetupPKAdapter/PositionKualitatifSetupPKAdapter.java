...
import com.enseval.samuelseptiano.hcservice.Model.APIModel.SetupPK.PKSetting.PKSettingSettingKualitatif;
...
public class PositionKualitatifSetupPKAdapter extends RecyclerView.Adapter<PositionKualitatifSetupPKAdapter.MyViewHolder> {

    private List<PKSettingHeaderKualitatif> KPIList;
    private Context context;
    private Activity activity;
    private ArrayList<PKSettingHeaderKualitatif> KPIListFilter = new ArrayList<>();
    ...
    public interface EventListener {
        List <PKSettingHeaderKualitatif> getSetupPositionModels();
        void setSetupPositionModels(List<PKSettingHeaderKualitatif> setupPositionModelList);
    }
    ...
    public PositionKualitatifSetupPKAdapter(List<PKSettingHeaderKualitatif> KPIList, Context context, Activity activity, EventListener listener, List<EmpJobLvlModel>empJobLvlModelList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        PKSettingHeaderKualitatif setupPositionModel = KPIList.get(position);
        ...
        holder.lnTemp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ConnectivityReceiver.isConnected()) {
                    // code block
                    fr = new PositionSetupDetailPKFragment();
    ...
    private void showSettingDialog(String title, int pos){
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<PKSettingSettingKualitatif> paSettingSettingList = new ArrayList<>();
                for(int i=0;i<tgGologan.getTags().size();i++){
                    for(int j=0;j<empJobLvlModelList.size();j++) {
                        if (tgGologan.getTags().get(i).equals(empJobLvlModelList.get(j).getJoblvlcode())){
                            PKSettingSettingKualitatif paSettingSetting = new PKSettingSettingKualitatif();
                ...
                Call<List<KPISettingSettingResponse>> call = apiService.postPAKPISettingSettingKualitatifPK(aaa,"Bearer "+usr.get(0).getToken());
                    ...
                    public void onResponse(Call<List<KPISettingSettingResponse>> call, Response<List<KPISettingSettingResponse>> response) {
                        ...
                        try {
                            if (response.body().get(0).result.equals("BERHASIL")) {
                                Toast.makeText(context, " Setting Sukses", Toast.LENGTH_SHORT).show();
