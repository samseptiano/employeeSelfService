package com.enseval.samuelseptiano.hcservice.Carrousel;
...
public class ViewPagerCarouselView extends RelativeLayout {
    ...
    RelativeLayout rlPage;          // Carousel view item indicator, the little bullets at the bottom of the carousel
    ...
    protected void onFinishInflate() {
        ...
        rlPage = (RelativeLayout) this.findViewById(R.id.rl_page_container);

//        btnNext = this.findViewById(R.id.buttonNext);
//        btnPrev = this.findViewById(R.id.buttonPrev);
    }
    ...
    private void initCarousel() {
        ...
        vpCarousel.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                //Toast.makeText(getContext(),"gjhghj0",Toast.LENGTH_SHORT).show();
            }
