...
public class PositionSetupPKAdapter extends RecyclerView.Adapter<PositionSetupPKAdapter.MyViewHolder> {

    private List<PKSettingHeader> paSettingHeaderList;
    private List<PKSettingHeader> paSettingHeaderListFilter = new ArrayList<>();
    ...
    public interface EventListener {
        List <SetupPositionPKModel> getSetupPositionModels();
        void setSetupPositionModels(List<SetupPositionPKModel> setupPositionModelList);
    }
    ...
    public PositionSetupPKAdapter(List<PKSettingHeader> paSettingHeaderList, Context context, Activity activity,EventListener listener,List<EmpJobTtlModel>empJobTtlModelList,List<EmpOrgModel>empOrgModelList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        PKSettingHeader setupPositionModel = paSettingHeaderList.get(position);
...
//            }
    ...
    private void showSettingDialog(String title, int pos){
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<tgOrganisasi.getTags().size();i++){
                    for(int j=0;j<empOrgModelList.size();j++) {
                        if (tgOrganisasi.getTags().get(i).equals(empOrgModelList.get(j).getOrgName())){
                            PKSettingSetting paSettingSetting = new PKSettingSetting();
                ...
                Set<PKSettingSetting> set = new HashSet<>(paSettingSettingList);
                ...
                Call<List<KPISettingSettingResponse>> call = apiService.postPAKPISettingSettingPK(aaa,"Bearer "+usr.get(0).getToken());
    ...
    public void filter(String charText) {
        ...
        {
            for (PKSettingHeader wp : paSettingHeaderListFilter) {
