package com.enseval.samuelseptiano.hcservice.Fragment.PerformanceAppraisalPAFragment.adapter;
...
public class TabsAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            ...
            case 1:
                return new TotalFragment("Approved",kpiApproveListsApprove,mContext.getResources().getDrawable(R.drawable.complete)).newInstance("Approve",kpiApproveListsApprove,mContext.getResources().getDrawable(R.drawable.no_results_found));
            case 2:
                return new TotalFragment("Not Approved",kpiApproveListsNotApprove,mContext.getResources().getDrawable(R.drawable.approved)).newInstance("Not Approve",kpiApproveListsNotApprove,mContext.getResources().getDrawable(R.drawable.approved));
