package com.enseval.samuelseptiano.hcservice.Session;
...
public class SessionManagement {
    ...
    private static final String RAN_BEFORE = "RanBefore";
    ...
    public void createLoginSession(String nik, String password){
        ...
        editor.putBoolean(RAN_BEFORE,false);
    ...
    public void logoutUser(){
        ...
        MaterialShowcaseView.resetAll(_context);
        editor.clear();
        editor.commit();
    ...
    public boolean isranBefore(){
        return pref.getBoolean(RAN_BEFORE, false);
    }
    public void updateRanBefore(boolean ranBefore){
        editor.putBoolean(RAN_BEFORE, ranBefore);
        editor.commit();
    }
