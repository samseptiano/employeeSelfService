...
public class RoutingHomeDetail implements RoutingHomeDetailInterface {
    ...
    public void routingChat(String roomName, String friendName, String friendNik, String semester, String tahun, String kualitatif, String kuantitatif, Context context, List<String> KPIItems,String friendBranchName,String friendDept, String friendJobTitle,String foto,String from, String empType){
        fr = new ChatFragment();
        Bundle bundle = new Bundle();
