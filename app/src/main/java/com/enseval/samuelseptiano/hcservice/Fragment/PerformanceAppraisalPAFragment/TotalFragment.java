package com.enseval.samuelseptiano.hcservice.Fragment.PerformanceAppraisalPAFragment;
...
import com.enseval.samuelseptiano.hcservice.Adapter.RecyclerViewAdapter.KPIAdapterTahunan.KPIApproveListAdapterTahunan;
...
//        }
    ...
    private void prepareData(String nik, String token) {
        ...
        Call<List<EmpOrgModel>> call = apiService.getEmpOrg(nik,Integer.toString(Calendar.getInstance().get(Calendar.YEAR)),"Bearer "+token);
...
//                Toast.makeText(getContext(),response.code()+"",Toast.LENGTH_LONG).show();
                ...
                for (int i=0;i<empOrgModelList.size();i++){
                    orgNameList.add(empOrgModelList.get(i).getOrgName());
                }
...
//            }
    ...
    private void showDialogFilter(){
        ...
        spinnerTahun.setSelectedIndex(2);
