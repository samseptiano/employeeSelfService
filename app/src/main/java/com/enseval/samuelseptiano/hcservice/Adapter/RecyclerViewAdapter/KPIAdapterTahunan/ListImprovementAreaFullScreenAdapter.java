...
//        dialogs.setCancelable(false);
        ...
        dialogs.setOnKeyListener(new Dialog.OnKeyListener() {
            ...
            public boolean onKey(DialogInterface dialogInterface, int i, KeyEvent keyEvent) {
                ...
                else if(i == KeyEvent.KEYCODE_1 || i == KeyEvent.KEYCODE_2 ||i == KeyEvent.KEYCODE_3 ||i == KeyEvent.KEYCODE_4 ||i == KeyEvent.KEYCODE_5 ||i == KeyEvent.KEYCODE_6 ||i == KeyEvent.KEYCODE_7 ||i == KeyEvent.KEYCODE_8 ||i == KeyEvent.KEYCODE_9 ||i == KeyEvent.KEYCODE_0 ) {
                    return false;
                }
