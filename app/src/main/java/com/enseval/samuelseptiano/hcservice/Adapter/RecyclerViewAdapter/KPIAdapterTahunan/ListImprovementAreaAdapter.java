...
//        holder.cbDevPlan.setChecked(false);
    ...
    public void showIDPDialog(String idpTitle,List<DevPlanDetail> devPlanDetailList, int position, String isButtonHide){
...
//        dialogs.setCancelable(false);
        ...
        if(isButtonHide.equals("HIDE")){
            btnGoToIdp.setVisibility(View.GONE);
        }
        else{
            btnGoToIdp.setVisibility(View.VISIBLE);
        }
                                ...
                                public void onResponse(Call<List<UserListDevPlan>> call, Response<List<UserListDevPlan>> response) {
                                    ...
                                    try {
                                        ...
                                        AlertDialog alertbox = new AlertDialog.Builder(context)
                                                .setMessage("Individual development plan tidak dapat dibuka karena masih menunggu approval oleh atasan langsung.")
                                                ...
                                                .show();
                                        alertbox.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(context.getColor(R.color.colorPrimary));
