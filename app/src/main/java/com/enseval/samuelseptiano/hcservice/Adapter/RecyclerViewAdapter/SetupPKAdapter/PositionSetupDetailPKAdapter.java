...
public class PositionSetupDetailPKAdapter extends RecyclerView.Adapter<PositionSetupDetailPKAdapter.MyViewHolder> {
    ...
    private List<PKSettingHeader> paSettingHeaderList = new ArrayList<>();
    ...
    public interface EventListener {
        ...
        List <PKSettingHeader> getPASettingHeader();
        void setPaSettingHeaderList(List<PKSettingHeader> paSettingHeaderList);
...
//            Toast.makeText(context,Integer.toString(position)+" "+questions.get(position-1).getKPIcategory()+" "+category,Toast.LENGTH_SHORT).show();
    ...
    public PositionSetupDetailPKAdapter(List<SetupPositionDetailPKModel> setupPositionDetailModelList, Context context, Activity activity, EventListener listener, List<PKSettingHeader> paSettingHeaderList,String type ) {
...
//                          }
                    ...
                    if(ctr==0){
                        ...
                        Call<Void> call = apiService.postPAKPISettingHeaderPKOne(paSettingHeaders, "Bearer " + usr.get(0).getToken());
