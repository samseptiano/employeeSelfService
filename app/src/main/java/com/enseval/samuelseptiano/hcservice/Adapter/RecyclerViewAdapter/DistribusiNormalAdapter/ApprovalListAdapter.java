...
public class ApprovalListAdapter extends RecyclerView.Adapter<ApprovalListAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tvApproval,tvApprovalName,tvDate,tvStatus, textViewStatus,textViewDate;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.textViewStatus.setText("Status Approval "+(position+1));
        holder.textViewDate.setText("Date Approved ");
