...
public class EmployeeSetupPKAdapter extends RecyclerView.Adapter<EmployeeSetupPKAdapter.MyViewHolder> {

    private List<SetupEmployeePKModel> KPIList;
    private Context context;
    private Activity activity;
    private ArrayList<SetupEmployeePKModel> KPIListFilter = new ArrayList<>();
    ...
    public EmployeeSetupPKAdapter(List<SetupEmployeePKModel> KPIList, Context context, Activity activity,String KPIType) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        SetupEmployeePKModel kpiApproveList = KPIList.get(position);
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ConnectivityReceiver.isConnected()) {
                    // code block
                    fr = new EmployeeSetupDetailPKFragment();
                    ...
                    bundle3.putString("pkid", kpiApproveList.getPkid());
                    ...
                    ft.addToBackStack("EmployeeSetupDetailPKFragment");
                    ft.commit();
    ...
    public void filter(String charText) {
        ...
        {
            for (SetupEmployeePKModel wp : KPIListFilter) {
