...
public class DistNormalH {
    ...
    public String getDNALASANREJECT() {
        return DNALASANREJECT;
    }

    public void setDNALASANREJECT(String DNALASANREJECT) {
        this.DNALASANREJECT = DNALASANREJECT;
    }

    @SerializedName("dnalasanreject")
    private String DNALASANREJECT;
