...
//        actionBar.setTitle(empType+" Team Performance");
        ...
        call.enqueue(new Callback<List<KPIApproveListPJ>>() {
            ...
            public void onResponse(Call<List<KPIApproveListPJ>> call, Response<List<KPIApproveListPJ>> response) {
                ...
                List<KPIApproveListPJ> kpiApproveLists2 = new ArrayList<>();
                for (int i = 0; i < kpiApproveLists.size(); i++) {
                    ...
                    //sebagai atasan 2
                        ...
                        kpiApproveLists2.add(kpiApproveLists.get(i));
                        if (kpiApproveLists.get(i).getStatus().equals("A")) {
                            kpiApproveListsNotApprove.add(kpiApproveLists.get(i));

                        }
                        if (kpiApproveLists.get(i).getStatus().equals("C")) {
                            kpiApproveListsApprove.add(kpiApproveLists.get(i));
...
//                        }
                    ...
                    else if (kpiApproveLists.get(i).getNIKAtasan2().equals(usr.get(0).getEmpNIK()) && kpiApproveLists.get(i).getStatus2().equals("") && kpiApproveLists.get(i).getStatus1().equals("")) {
                       kpiApproveLists.remove(i);
                    }
                    else if((!kpiApproveLists.get(i).getNIKAtasan1().equals(usr.get(0).getEmpNIK())&& !kpiApproveLists.get(i).getNIKAtasan2().equals(usr.get(0).getEmpNIK()))&&kpiApproveLists.get(i).getStatus2().equals("Approved") && kpiApproveLists.get(i).getStatus1().equals("Approved")){
                        if(kpiApproveLists.get(i).getCheckByNIK().length()<1){
                            kpiApproveListsNotApprove.add(kpiApproveLists.get(i));
                ...
                if(!filterPJModel.getDirektorat().equals("") && !filterPJModel.getSite().equals("")) {
                    for (int i = 0; i < kpiApproveLists.size(); i++) {
                        ...
                        if (kpiApproveLists.get(i).getNIKAtasan1().equals(usr.get(0).getEmpNIK())) {
                            if (kpiApproveLists.get(i).getStatus() == null || kpiApproveLists.get(i).getStatus().equals("O") || kpiApproveLists.get(i).getStatus().equals("S")) {
                                ...
                                if (filterPJModel.getDirektorat().contains(kpiApproveLists.get(i).getOrgName()) || filterPJModel.getSite().contains(kpiApproveLists.get(i).getLocationName())&& ((dAwal.compareTo(selesaiKontrak)+dAkhir.compareTo(selesaiKontrak))==0)) {
                                    kpiApproveListsApprove.add(kpiApproveLists.get(i));
                                }
                            }
                        }
                        //sebagai atasan 2
                            ...
                            if(kpiApproveLists.get(i).getCheckDate()==null){
                                kpiApproveListsNotApprove.add(kpiApproveLists.get(i));
                        ...
                        if (kpiApproveLists.get(i).getNIKAtasan1().equals(usr.get(0).getEmpNIK())) {
                            if (kpiApproveLists.get(i).getStatus() == null || kpiApproveLists.get(i).getStatus().equals("O") || kpiApproveLists.get(i).getStatus().equals("S")) {
                               // if (filterPJModel.getSite().contains(kpiApproveLists.get(i).getLocationName())) {
                                ...
                                if (filterPJModel.getSite().contains(kpiApproveLists.get(i).getLocationName())&& ((dAwal.compareTo(selesaiKontrak)+dAkhir.compareTo(selesaiKontrak))==0)) {
                                    kpiApproveListsApprove.add(kpiApproveLists.get(i));
                                }
                            }
                        }
                        ...
                        if (kpiApproveLists.get(i).getNIKAtasan1().equals(usr.get(0).getEmpNIK())) {
                            if (kpiApproveLists.get(i).getStatus() == null || kpiApproveLists.get(i).getStatus().equals("O") || kpiApproveLists.get(i).getStatus().equals("S")) {
                               // if (filterPJModel.getDirektorat().contains(kpiApproveLists.get(i).getOrgName())) {
                                ...
                                if (filterPJModel.getDirektorat().contains(kpiApproveLists.get(i).getOrgName())&& ((dAwal.compareTo(selesaiKontrak)+dAkhir.compareTo(selesaiKontrak))==0)) {
                                    kpiApproveListsApprove.add(kpiApproveLists.get(i));
                                }
                            }
                        }
                    ...
                    for (int i = 0; i < kpiApproveLists.size(); i++) {
                        ...
                        if (kpiApproveLists.get(i).getNIKAtasan1().equals(usr.get(0).getEmpNIK())) {
                            ...
                            } else if((dAwal.compareTo(selesaiKontrak)+dAkhir.compareTo(selesaiKontrak))==0){
                                kpiApproveListsApprove.add(kpiApproveLists.get(i));
                        ...
                        //sebagai atasan 2
                            ...
                            } else if(kpiApproveLists.get(i).getStatus().equals("C") && (dAwal.compareTo(selesaiKontrak)+dAkhir.compareTo(selesaiKontrak))==0){
                                    kpiApproveListsApprove.add(kpiApproveLists.get(i));
                            }
                        }
