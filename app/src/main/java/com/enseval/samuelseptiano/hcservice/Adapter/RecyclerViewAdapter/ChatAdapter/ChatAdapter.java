...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(ChatAdapter.MyViewHolder holder, int position) {
        ...
        if(listener.getKPIItem().equals("") && (chatModel.getKualtatif().equals("") && chatModel.getKuantitatif().equals("") && chatModel.getTahun().equals(listener.getTahun()))){
        ...
        else if((!listener.getKPIItem().equals("") && (chatModel.getKualtatif().equals(listener.getKPIItem()) || chatModel.getKuantitatif().equals(listener.getKPIItem()))) && chatModel.getTahun().equals(listener.getTahun())){
