package com.enseval.samuelseptiano.hcservice.Fragment.TablayoutFragment;
...
//                    return true;
                case R.id.navigation_notification:
                    ((MainActivity)getActivity()).inflateNotificationFragment(ConnectivityReceiver.isConnected());
                    return true;
