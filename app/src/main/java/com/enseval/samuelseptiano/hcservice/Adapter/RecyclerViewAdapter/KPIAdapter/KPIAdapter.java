        ...
        try {
            if (holder instanceof HeaderViewHolder) {
                ...
                if(listener.isEditables().equals("N") && type.equals("Approve")){
                    ...
                    footerHolder.edtCatatan.setEnabled(false);
                    ...
                    footerHolder.edtCatatan.setEnabled(true);
...
//                    Devplan = spinnerDevPlan.getItems().get(spinnerDevPlan.getSelectedIndex()).toString();
                ...
                footerHolder.edtCatatan.setText(kpiHeader.getCataatan());
...
//            semester = (TextView) view.findViewById(R.id.tvSemester);
    ...
    private class FooterViewHolder extends RecyclerView.ViewHolder {
        ...
        EditText edtKelebihan,edtCatatan, edtkekurangan, edtRencanaTindaklanjut;
        TextView footertext, tvMaxtext,tvmaxtextCatatan;
        ...
        public FooterViewHolder(View view) {
            ...
            tvmaxtextCatatan = view.findViewById(R.id.tvMaxTextCatatan);
...
//            spinnerDevPlan.setItems(tahuns);
            ...
            edtCatatan.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start,
                    ...
                    if(edtCatatan.getText().toString().length()>0) {
                        kpiHeader.setCataatan(edtCatatan.getText().toString().replaceAll("'", ""));
                        listener.setQuestion(kpiHeader,0);
                        listener.setUbah(true);
                    }
                    else{
                    ...
                    tvmaxtextCatatan.setText(s.length()+"/500");
                }
            });
