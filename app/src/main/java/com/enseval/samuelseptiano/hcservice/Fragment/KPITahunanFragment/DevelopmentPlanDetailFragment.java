                                                ...
                                                call.enqueue(new Callback<Void>() {
                                                    ...
                                                    public void onResponse(Call<Void> call, Response<Void> response) {
                                                        ...
                                                        emailSentModel.MESSAGE="<br /> <br /> Bersama ini kami informasikan, IDP untuk karyawan dibawah ini menunggu approval Bapak/Ibu</p>\n" +
                                                                ...
                                                                "</tbody>\n" +
                                                                "</table>\n" +
                                                                "<p><br /> Approval IDP dapat dilakukan melalui aplikasi HC Service yang dapat diakses <strong>melalui HC Service web <a href=\"#\">(klik disini)</a> atau HC Service Mobile. </strong> <br /> <br /> Terima kasih <br /> <br /> <em>(Note: email ini adalah hasil generate otomatis dari aplikasi HC Service)</em></p>";
