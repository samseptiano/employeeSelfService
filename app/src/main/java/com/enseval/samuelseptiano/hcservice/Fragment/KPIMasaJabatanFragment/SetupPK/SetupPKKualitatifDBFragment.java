...
import com.enseval.samuelseptiano.hcservice.Adapter.RecyclerViewAdapter.SetupPKAdapter.PositionKualitatifSetupPKAdapter;
...
import com.enseval.samuelseptiano.hcservice.Model.APIModel.SetupPK.SetupPositionKualitatifPKModel;
...
public class SetupPKKualitatifDBFragment extends Fragment implements PositionKualitatifSetupPKAdapter.EventListener {
    ...
    List<SetupPositionKualitatifPKModel> setupPositionModelList = new ArrayList<>();
    List<EmpJobLvlModel> empJobLvlModelList = new ArrayList<>();

    EmployeeSetupPKAdapter employeeSetupPAAdapter;
    PositionKualitatifSetupPKAdapter positionSetupPAAdapter;
            ...
            public void onClick(View view) {
                ...
                AlertDialog alertbox = new AlertDialog.Builder(getContext())
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ApiInterface apiService = ApiClient.getClientTest(getContext()).create(ApiInterface.class);
                                Call<Void> call = apiService.deletePAKPISettingHeaderKualitatifPK(aaa, "Bearer " + usr.get(0).getToken());
                                call.enqueue(new Callback<Void>() {
                                    @Override
                                    public void onResponse(Call<Void> call, Response<Void> response) {
                                        int statusCode = response.code();
    ...
    private void prepareDataEmployee() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            employeeSetupPAAdapter = new EmployeeSetupPKAdapter(setupEmployeeModelList, getContext(), getActivity(),"KUALITATIF");
    ...
    private void prepareDataPosition() {
        ...
        pd.show();
        ApiInterface apiService = ApiClient.getClientTest(getContext()).create(ApiInterface.class);
        Call<List<PKSettingHeaderKualitatif>> call = apiService.getPAKualitatifSettingHeaderPK("Bearer "+usr.get(0).getToken());
        call.enqueue(new Callback<List<PKSettingHeaderKualitatif>>() {
            @Override
            public void onResponse(Call<List<PKSettingHeaderKualitatif>> call, Response<List<PKSettingHeaderKualitatif>> response) {
                int statusCode = response.code();

                paSettingHeaderKualitatifList = response.body();

                positionSetupPAAdapter = new PositionKualitatifSetupPKAdapter(paSettingHeaderKualitatifList, getContext(), getActivity(), SetupPKKualitatifDBFragment.this, empJobLvlModelList);
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getContext());
    ...
    private void showAddPositionDialog() {
        ...
        btnAddTemplate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ApiInterface apiService = ApiClient.getClientTest(getContext()).create(ApiInterface.class);
                Call<Void> call2 = apiService.postPAKPISettingHeaderKualitatifPK(paSettingHeaders,"Bearer "+usr.get(0).getToken());
    ...
    @Override
    public List<PKSettingHeaderKualitatif> getSetupPositionModels() {
        return paSettingHeaderKualitatifList;
    }

    @Override
    public void setSetupPositionModels(List<PKSettingHeaderKualitatif> setupPositionModelList) {
