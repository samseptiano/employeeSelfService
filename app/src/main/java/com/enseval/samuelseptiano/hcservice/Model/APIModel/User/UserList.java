...
public class UserList implements Serializable {
    ...
    public String fotoBawahan;

    @SerializedName("jobTitleAtasan1")
    public String jobTitleAtasan1;

    @SerializedName("jobTitleAtasan2")
    public String jobTitleAtasan2;

    @SerializedName("mulaiKontrak")
    public String mulaiKontrak;
    @SerializedName("selesaiKontrak")
    public String selesaiKontrak;
