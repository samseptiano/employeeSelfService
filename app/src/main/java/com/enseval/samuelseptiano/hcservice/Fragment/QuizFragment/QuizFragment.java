package com.enseval.samuelseptiano.hcservice.Fragment.QuizFragment;
...
import com.enseval.samuelseptiano.hcservice.Adapter.RecyclerViewAdapter.QuizAdapter.QuizAdapter;
...
import com.enseval.samuelseptiano.hcservice.Model.APIModel.Survey.QuestionAnswerSurvey;
import com.enseval.samuelseptiano.hcservice.Model.APIModel.Survey.Survey;
import com.enseval.samuelseptiano.hcservice.Model.CheckBoxQuizOption;
...
public class QuizFragment extends Fragment {
    ...
    private void prepareQuestions() {
        ...
        apiService.getQuestionAnswerSurveyID(id,"Bearer "+usr.get(0).getToken())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Observer<QuestionAnswerResponse>() {
                    ...
                    public void onNext(QuestionAnswerResponse questionAnswerResponse) {
                        questions = questionAnswerResponse.getQuestionAnswers();
                    ...
                    public void onComplete() {
                        apiService.getSurveyID(id,"Bearer "+usr.get(0).getToken())
                                .subscribeOn(Schedulers.io())
                                .observeOn(AndroidSchedulers.mainThread())
                                .unsubscribeOn(Schedulers.io())
...
//            initQuestionsAdapter(numbRadio);
    ...
    private void showDialogHint(){
        ...
        tvContentHint.setText("Isilah Feedback Berdasarkan Penilaian Anda Sendiri...");
