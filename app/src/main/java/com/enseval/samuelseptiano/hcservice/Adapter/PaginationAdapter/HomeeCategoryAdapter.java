package com.enseval.samuelseptiano.hcservice.Adapter.PaginationAdapter;
...
//        homeListFilter.add(response);
    ...
    public void addAll(List<Home> postItems) {
        ...
        homeListFilter.addAll(postItems);
        //Toast.makeText(context,Integer.toString(mPostItems.size()),Toast.LENGTH_LONG).show();
...
//                    routingHomeDetailInterface.routingHomeDetail(item.getEventType(),context,item.getEventId());
                    Toast.makeText(context,Integer.toString(position)+" "+item.getEventId(),Toast.LENGTH_SHORT).show();
...
//                    mPostItems.add(wp);
        ...
        Toast.makeText(context,homeListFilter.get(3).getEventId(),Toast.LENGTH_LONG).show();
        Toast.makeText(context,Integer.toString(homeListFilter.size()),Toast.LENGTH_LONG).show();
